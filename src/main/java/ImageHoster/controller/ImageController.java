...
public class ImageController {
  ...
  /*    Image upload issues:
  https://github.com/upgrad-edu/Course_4_Assignment/issues/1
  image title is not unique so combination of imageId and image title to navigate will solve this issue
  added try catch block for error handling if no comments available
  */
  ...
  https://github.com/upgrad-edu/Course_4_Assignment/issues/2
  check owner id(userId) of the image with userId of logged in user if both same then only allow user to edit image
  */
  ...
  https://github.com/upgrad-edu/Course_4_Assignment/issues/2
  check owner id(userId) of the image with userId of logged in user if both same then only allow user to delete image
  */
